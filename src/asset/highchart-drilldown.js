...
;(function(f) {
  ...
  n(f, 'modules/drilldown.src.js', [f['parts/Globals.js']], function(d) {
    ...
    m.prototype.addSingleSeriesAsDrilldown = function(a, b) {
      ...
      ;(f = this.drilldownLevels[this.drilldownLevels.length - 1]) &&
        f.levelNumber !== l &&
        (f = void 0)
      ...
      c.chart.series.forEach(function(a) {
        a.xAxis !== g ||
          a.isDrilling ||
          ((a.options._ddSeriesId = a.options._ddSeriesId || B++),
          (a.options._colorIndex = a.userOptions._colorIndex),
          (a.options._levelNumber = a.options._levelNumber || l),
          f
            ? ((h = f.levelSeries), (r = f.levelSeriesOptions))
            : (h.push(a), r.push(a.options)))
      })
      a = q(
        {
          levelNumber: l,
      ...
      g &&
        ...
        (e.userMin = e.userMax = null))
      c.type === b.type &&
        ((b.animate = b.animateDrilldown || n), (b.options.animation = !0))
    }
    ...
    m.prototype.getDrilldownBackText = function() {
      ...
      if (a && 0 < a.length)
        return (
          ...
          C(this.options.lang.drillUpText, a)
        )
    }
        ...
        for (
          ...
          if (((h = b[g]), h.levelNumber === c)) {
            ...
            if (!d.chart)
              for (k = e.length; k--; )
                if (
                  e[k].options.id === h.lowerSeriesOptions.id &&
                  e[k].options._levelNumber === c + 1
                ) {
                  d = e[k]
                  break
                }
            ...
            l.type === d.type &&
              ...
              d.animateDrillupFrom && d.chart && d.animateDrillupFrom(h))
            l.options._levelNumber = c
            d.remove(!1)
            l.xAxis &&
              ((k = h.oldExtremes),
              l.xAxis.setExtremes(k.xMin, k.xMax, !1),
              l.yAxis.setExtremes(k.yMin, k.yMax, !1))
            h.resetZoomButton &&
              ((a.resetZoomButton = h.resetZoomButton),
          ...
          for (c = 0; c < g.length; c++)
            (d = b.options.data[c]),
              'number' !== typeof d &&
                ...
                d.drilldown &&
                  (a.ddPoints[g[c]] || (a.ddPoints[g[c]] = []),
                  a.ddPoints[g[c]].push(e ? e[c] : !0)))
        })
      ...
      a ||
        (d.forEach(function(a) {
          b.options._ddSeriesId === a.lowerSeriesOptions._ddSeriesId &&
            ((e = a.shapeArgs), r || (e.fill = a.color))
        }),
        (e.x += t(h.oldPos, h.pos) - h.pos),
        this.points.forEach(function(a) {
          var c = a.shapeArgs
          r || (c.fill = a.color)
          a.graphic &&
            a.graphic
              .attr(e)
              .animate(q(a.shapeArgs, { fill: a.color || b.color }), k)
    ...
    p.prototype.animateDrillupFrom = function(a) {
      ...
      this.points.forEach(function(k) {
        ...
        h &&
          (delete k.graphic,
          e.chart.styledMode || (f.fill = a.color),
          b.duration
            ? h.animate(f, d.merge(b, { complete: l }))
            : (h.attr(f), l()))
      })
    }
    z &&
        ...
        animateDrilldown: function(a) {
          ...
          a ||
            (this.points.forEach(function(a, h) {
              ...
              if (a.graphic)
                a.graphic
                  .attr(d.merge(g, { start: e + h * k, end: e + (h + 1) * k }))
                  [c ? 'animate' : 'attr'](l, c)
            }),
            (this.animate = null))
        },
    ...
    d.Point.prototype.doDrilldown = function(a, b, c) {
      ...
      d.ddDupes || (d.ddDupes = [])
      for (; f-- && !h; )
        e.series[f].id === this.drilldown &&
          -1 === d.ddDupes.indexOf(this.drilldown) &&
          ((h = e.series[f]), d.ddDupes.push(this.drilldown))
      v(
        d,
        'drilldown',
        {
    ...
    A.prototype.drillable = function() {
      ...
      g &&
        (b && e && e.length
          ? ((b.drillable = !0),
            b.basicStyles || f || (b.basicStyles = d.merge(b.styles)),
            b
          ...
          : b &&
            b.drillable &&
            (f || ((b.styles = {}), b.css(b.basicStyles)),
            b.on('click', null),
    ...
    d.addEvent(d.Series, 'afterDrawDataLabels', function() {
      ...
      this.points.forEach(function(d) {
        ...
        d.drilldown &&
          ...
          ('contrast' !== a.color ||
            c ||
            (f.color = b.getContrast(d.color || this.color)),
